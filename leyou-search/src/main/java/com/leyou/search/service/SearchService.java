...
public class SearchService {
    ...
    private List<Map<String, Object>> getParamAggResult(Long cid, BoolQueryBuilder basicQuery) {
        ...
        //解析聚合查询结果集,key:规格参数名（聚合名称），value:聚合对象
        List<Map<String, Object>> specs = new ArrayList<>();
        Map<String, Aggregation> aggregationoMap = goodsPage.getAggregations().asMap();
        for (Map.Entry<String, Aggregation> entry : aggregationoMap.entrySet()) {
